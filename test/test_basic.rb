...
class TestTableBasic < Test::Unit::TestCase
  ...
  def test_list_recordids
    ...
    recordid1 = t.allocate_record
    assert_equal([recordid1], t.list_recordids)
    recordid2 = t.allocate_record
  ...
  def test_natjoin2
    ...
    assert_equal([{"_recordid"=>0, "a"=>"1", "b"=>"2", "c"=>"3"},
                  ...
                  {"_recordid"=>2, "a"=>"0", "b"=>"4", "c"=>"5"}], t3.to_a)
  end
  ...
  def test_rename_field
    ...
    assert_equal([{"_recordid"=>0, "a"=>1, "b"=>2}], t1.to_a)
